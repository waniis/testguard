...
if (!class_exists('lpc_fpdi_bridge')) {
    require_once('lpc_fpdi_bridge.php');
}

/**
 * Class FPDF_TPL
 */
class lpc_FPDF_TPL extends lpc_fpdi_bridge
{
    /**
    ...
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
    ...
    public function endTemplate()
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::endTemplate'), $args);
        }
    ...
    public function SetFont($family, $style = '', $size = null, $fontfile = '', $subset = 'default', $out = true)
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::SetFont'), $args);
        }
    ...
    )
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::Image'), $args);
        }
    ...
    public function AddPage($orientation = '', $format = '', $rotationOrKeepmargins = false, $tocpage = false)
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::AddPage'), $args);
        }
    ...
    public function Link($x, $y, $w, $h, $link, $spaces = 0)
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::Link'), $args);
        }
    ...
    public function AddLink()
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::AddLink'), $args);
        }
    ...
    public function SetLink($link, $y = 0, $page = -1)
    {
        if (is_subclass_of($this, 'lpc_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'lpc_TCPDF::SetLink'), $args);
        }
