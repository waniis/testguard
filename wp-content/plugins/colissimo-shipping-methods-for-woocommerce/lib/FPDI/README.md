...
$loader->register();
$loader->addNamespace('setasign\LPC_Fpdi', 'path/to/src/');
```
...
- The classes and traits are namespaced now: `setasign\LPC_Fpdi`
...
- If you want to use **FPDI with TCPDF** you need to refactor your code to use the class `Tcpdf\LPC_Fpdi`
...
```php
<?php
use setasign\LPC_Fpdi\LPC_Fpdi;
// or for usage with TCPDF:
// use setasign\LPC_Fpdi\Tcpdf\LPC_Fpdi;

// or for usage with tFPDF:
// use setasign\LPC_Fpdi\Tfpdf\LPC_Fpdi;
