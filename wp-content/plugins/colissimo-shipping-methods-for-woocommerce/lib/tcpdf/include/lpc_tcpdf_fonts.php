...
class LPC_TCPDF_FONTS {
	...
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		...
		$pfile = '<'.'?'.'php'."\n";
		$pfile .= '// LPC_TCPDF FONT FILE DESCRIPTION'."\n";
...
// ====================================================================================================================
	...
	public static function UTF8ArrayToUniArray($ta, $isunicode=true) {
		if ($isunicode) {
			return array_map(array('LPC_TCPDF_FONTS', 'unichrUnicode'), $ta);
		}
		return array_map(array('LPC_TCPDF_FONTS', 'unichrASCII'), $ta);
	}
	...
	public static function getUniord($uch) {
		if (function_exists('mb_convert_encoding')) {
		    // Switch for PHP < 7.1
            $arrayResponseUnpack = @unpack('N', mb_convert_encoding($uch, 'UCS-4BE', 'UTF-8'));
            $char = $arrayResponseUnpack[1];
            // Original
	...
	public static function UTF8StringToArray($str, $isunicode=true, &$currentfont=array()) {
		if ($isunicode) {
			...
			$carr = array_map(array('LPC_TCPDF_FONTS', 'uniord'), $chars);
		} else {
			$chars = str_split($str);
