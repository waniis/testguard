<div class="marque-award">
  <div class="main-wrapper">
    <div class="marque-award-container">
      <div class="marque-award-intro">
        <div class="subtitle-black">
          <?php the_field('award_title'); ?>
        </div>
        <div class="paragraph-black">
          <?php the_field('award_intro'); ?>
        </div>
      </div>
      <?php if( have_rows('awards') ): ?>  
      <ul role="list" class="marque-award-list w-list-unstyled">
       <?php while( have_rows('awards') ): the_row(); ?>
         <li class="marque-award-item">
          <div class="award-img-container">
            <img src="<?php the_sub_field('award_img'); ?>" loading="lazy" alt="">
          </div>
          <div class="paragraph-black">
