...
<?php if( have_rows('engagements') ): ?>
  <div class="marque-engagements">
    <div class="main-wrapper">
      <div class="marque-engagements-container">
        <ul role="list" class="engagements-list w-list-unstyled">
      <?php while( have_rows('engagements') ): the_row(); ?>
           <li class="engagements-item">
            <div class="engagements-img-container">
              <img src="<?php the_sub_field('engagements_picto'); ?>" loading="lazy" alt="" class="engagements-img">
            </div>
            <div class="engagements-text">
              <?php the_sub_field('engagements_text'); ?>
            </div>
          </li>
      <?php endwhile; ?>
  ...
  <div class="main-wrapper">
    <div class="advice-informations-container">
      <div class="advice-information-row">
        ...
        <div class="advice-informations-img">
          <img src="<?php the_field('highlighted_content_img'); ?>" loading="lazy" alt="" class="image-45">
          </div>
      </div>
    </div>
  </div>
