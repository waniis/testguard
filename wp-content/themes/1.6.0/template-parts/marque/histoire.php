<div class="marque-histoire">
  <div class="main-wrapper">
    <div class="marque-histoire-container">
      <div class="marque-histoire-intro">
        ...
        <?php if( have_rows('timeline') ): ?>
          <?php while( have_rows('timeline') ): the_row(); ?>
              <div class="histoire-row">
                <div class="histoire-col histoire-content">
                  <div class="histoire-content-inner">
                  ...
                  <div class="histoire-date-point">
                    <div class="div-block-310"></div>
                  </div>
                </div>
                <div class="histoire-col histoire-img-wrapper">
                  <img src="<?php the_sub_field('timeline_img'); ?>" loading="lazy" alt="">
                </div>
              </div>
          <?php endwhile; ?>
      <?php endif; ?>
    ...
    <div class="section-reference-wrapper">
      <div class="main-wrapper">
        ...
        <div class="reference-btn-container">
          <a href="<?php echo home_url().'/references/'?>" class="btn-arrow-border-white-smoke w-inline-block">
            <div class="btn-arrow-picto w-embed">
              <!--?xml version="1.0" encoding="UTF-8"?-->
              <svg viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
