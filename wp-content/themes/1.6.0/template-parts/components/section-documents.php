<div class="documentation-block"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/nos_documentations.svg?v=1616606927303" loading="lazy" alt="" class="distributor-img">
      <div class="distributor-text">
        <span class="documentation-title"><?php _e('Nos ', 'guard-industrie') ?><br><?php _e('documentation', 'guard-industrie') ?></span>
        <p class="documentation-description"><?php _e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.', 'guard-industrie') ?></p>
        <div class="documentation-btn-container">
          <a href="#" class="btn-arrow-border-white-smoke w-inline-block">
            ...
            <div class="btn-text"><?php _e('Consulter', 'guard-industrie') ?></div>
          </a>
        </div>
      </div>
    </div>