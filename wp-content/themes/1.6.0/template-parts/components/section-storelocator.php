<div class="main-wrapper">
  <div class="section-storelocator-container">
        <div class="section-storelocator-loc">
          <h3 class="main-title-white"><?php the_field('storelocator_title', 'option'); ?></h3>
          <div class="subtitle-white store-section-subtitle"><?php the_field('storelocator_text', 'option'); ?></div>
          ...
          <div class="store-locator-btn-container double">
            <a href="<?php the_field('storelocator_link_pro', 'option'); ?>" class="btn-arrow-white w-inline-block">
              <div class="btn-arrow-picto w-embed">
                <!--?xml version="1.0" encoding="UTF-8"?-->
                <svg viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <defs>
        ...
        <div class="section-storelocator-loc">
          <img src="<?php the_field('storelocator_img', 'option'); ?>" loading="lazy" alt="" class="section-storelocator-map">
          </div>
      </div>
</div>