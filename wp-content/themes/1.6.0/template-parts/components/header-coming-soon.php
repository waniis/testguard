<?php if ( have_rows('section_header') ): ?>
    <?php while ( have_rows('section_header') ) : the_row(); ?>
        <div class="header-container header-hero">
    <div class="hero-box" style='background-image: url(<?php the_sub_field('image_background'); ?>)'>
      <div class="slide-inside">
        <h2 class="slide-title"><?php the_sub_field('titre'); ?></h2>
        <h3 class="slide-subtitle"><?php the_sub_field('sous-titre'); ?></h3>
        
        <div class='btn-section'>
          <?php if( have_rows('header_cta') ): ?>
          <?php while( have_rows('header_cta') ): the_row(); ?>
            <a href="<?php echo the_sub_field('header_link'); ?>" class="btn-arrow-white w-inline-block">
              ...
              <div class="btn-text"><?php echo the_sub_field('link_text'); ?></div>
            </a>
        <?php endwhile; ?>
         <?php endif; ?>
          <?php if( have_rows('doc_cta') ): ?>
          <?php while( have_rows('doc_cta') ): the_row(); ?>
            <a href="<?php echo the_sub_field('fichier_media'); ?>" class="btn-arrow-white w-inline-block" target="_blank">
              <div class="btn-arrow-picto w-embed">
                <!--?xml version="1.0" encoding="UTF-8"?-->
                <svg viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <defs>
              ...
              <div class="btn-text"><?php echo the_sub_field('texte_fichier_cta'); ?></div>
            </a>
        <?php endwhile; ?>
         <?php endif; ?>
      </div>
