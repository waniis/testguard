<?php 
    if(get_u_slug()=="particuliers"){
        $featured_reference = get_field('references_highlight', 'option');
      } else { 
        $featured_reference = get_field('references_highlight_pro', 'option');
      }
    
        if( $featured_reference ): ?>
    <div class="section-reference white">
        ...
        <div class="reference-list">
          ...
          <div class="reference-col <?php if( !isset($featured_reference[2]) ): ?>col-half<?php endif; ?>">
            <div class="reference-item">
              ...
              <a href="<?php echo get_the_permalink($featured_reference[1]->ID); ?>" class="reference-text">
            ...
            <div class="reference-item">
             ...
             <a href="<?php echo get_the_permalink($featured_reference[2]->ID); ?>" class="reference-text">
