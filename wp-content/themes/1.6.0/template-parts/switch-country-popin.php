<div id="foreign-market-location-popin">
  <?php $popin_link = get_field('foreign_market_location_popin__link', 'options'); ?>
    <div class="popin">
        
        <?= get_field('foreign_market_location_popin__msg', 'options') ?>
        
        <div class="btn-container">
          <a class="btn-arrow-blue w-inline-block" style="width: fit-content;" href="<?= $popin_link['url'] ?>" target="<?= $popin_link['target'] ?>">
              ...
              <span class="btn-text"><?= $popin_link['title'] ?></span>
          </a>
          
          <button class="popin-button" onclick="document.getElementById('foreign-market-location-popin').style.display = 'none'">close</button>
        </div>
