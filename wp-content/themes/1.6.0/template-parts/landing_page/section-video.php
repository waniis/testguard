<?php
$video = get_field('section_video_landing');
if( $video ): ?>

<video autoplay loop playsinline data-main-url="<?php echo esc_url( $video['video_file'] ); ?>">
  <source type="video/mp4">
</video>
<div class="video-overlay">
    <div class="slide-inside">
      <h2 class="slide-title"><?php echo esc_html( $video['titre_section_video']); ?></h2>
      <h3 class="slide-subtitle"><?php echo esc_html( $video['texte_section_video']); ?></h3>
      <a href="#" class="btn-arrow-white w-inline-block start-video">
        ...
        <div class="btn-text"><?php _e('Voir la vidéo', 'guard-industrie') ?></div>
      </a>
    </div>
</div>
