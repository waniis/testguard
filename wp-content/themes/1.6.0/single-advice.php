<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="6050d9fd6f52a59339d8b270" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="conseils">
  ...
  <div class="advice-section"><?php include( locate_template( 'template-parts/single-advice.php', false, false ) ); ?></div>
