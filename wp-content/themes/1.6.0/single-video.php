<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="608a7c81bf5f4cdcd83eb25b" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="video">
  
  <?php wp_body_open(); ?>
  
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  <nav class="nav"><?php include( locate_template( 'template-parts/nav.php', false, false ) ); ?></nav>
  <div class="video-section"><?php include( locate_template( 'template-parts/single-video.php', false, false ) ); ?></div>
