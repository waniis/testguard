<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="608ffee9406d1004c7cac15b" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Catalogue" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="catalogue">
  
  <?php wp_body_open(); ?>
  
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  <nav class="nav"><?php include( locate_template( 'template-parts/nav.php', false, false ) ); ?></nav>
  <div class="catalogue-section"><?php include( locate_template( 'template-parts/single-catalogue.php', false, false ) ); ?></div>
