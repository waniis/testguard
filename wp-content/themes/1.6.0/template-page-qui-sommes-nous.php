...
<?php /*
        ...
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6050e4a98756c6a2084c4508" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Qui sommes-nous ?" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="qui-sommes-nous">
  ...
  <div class="header-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
    <div class="header-inside">
      ...
      <div class="marque-btn-container">
        <a href="<?php echo home_url().'/histoire/' ?>" class="btn-arrow-white w-inline-block">
          ...
          <div class="btn-text"><?php _e('notre histoire', 'guard-industrie') ?></div>
        </a>
      </div>
    </div>
  </div>
  <div class="marque-block"><?php include( locate_template( 'template-parts/marque/qui-sommes-nous.php', false, false ) ); ?></div>
