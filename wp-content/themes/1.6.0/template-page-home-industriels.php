<!DOCTYPE html>
<?php /*
        Template Name: home-industriels
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="608134f4f61882717954629b" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Home Industriels" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="home-industriels">
  ...
  <div class="home-prescripteur"><?php include( locate_template( 'template-parts/home-industriels.php', false, false ) ); ?></div>
