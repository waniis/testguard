<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="6033b6808f1a9cbe8d41042e" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
        ...
        <div class="swiper-slide header-slide">
          <div class="slide-box">
            <div class="slide-inside">
              <h2 class="slide-title"><?php _e('Guard industrie', 'guard-industrie') ?></h2>
              <h3 class="slide-subtitle"><?php _e('L’expert pour nettoyer, rénover,', 'guard-industrie') ?><br><?php _e(' traiter et protéger votre maison.', 'guard-industrie') ?></h3>
              <a href="<?php the_field('catalogue_particulier', 'option'); ?>" class="btn-arrow-white w-inline-block">
                ...
                <div class="btn-text"><?php _e('Voir la boutique', 'guard-industrie') ?></div>
              </a>
            </div>
          </div>
        </div>
