<!DOCTYPE html>
<?php /*
        Template Name: template-lasure-incolore
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6086e56e481b24d4f8a41897" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Template lasure incolore" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body-navless'; ?>" udesly-page="template-lasure-incolore">
  ...
  <div class="expertise-content"><?php include( locate_template( 'template-parts/lasure-incolore.php', false, false ) ); ?></div>
