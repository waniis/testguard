<!DOCTYPE html>
<?php /*
        Template Name: liste-conseils
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6050e5ca01c18cdeca219de5" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Liste Conseils" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="liste-conseils">
  ...
  <div class="listing-advice-container">
    <div class="listing-advice-wrapper">
      <div class="listing-advice">
        <div class="listing-filter-block">
          <div class="filter-heading"><?php _e('Filtrer par :', 'guard-industrie') ?></div>
          <div class="filter-wrapper"><?php filters_Advice(get_field('product_list_grid_id')); ?></div>
        </div>
  ...
  <?php if( get_u_slug()=="particuliers" || get_u_slug()=="pro-du-batiment" ) : ?><div>
    ...
    <div class="section-partners">
      <h3 class="main-title-white"><?php _e('Nos Partenaires e-commerce', 'guard-industrie') ?></h3>
      <ul role="list" class="partners-list w-list-unstyled"><?php partners_List(); ?></ul>
    </div>
  </div><?php endif; ?>
  <div class="section-bestseller-products">
    <div class="title-container">
      <div class="slider-product-previous"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron.svg?v=1621503422033" loading="lazy" alt="" class="image-40"></div>
      <h2 class="main-title-black"><?php _e('Meilleures ventes', 'guard-industrie') ?></h2>
      <div class="slider-product-next"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron.svg?v=1621503422033" loading="lazy" alt="" class="image-41"></div>
    </div>
