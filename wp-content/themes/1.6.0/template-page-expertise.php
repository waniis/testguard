...
<?php /*
        ...
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6050e41579314cd308e55551" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Expertise" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="expertise">
  ...
  <div class="marque-block"><?php include( locate_template( 'template-parts/marque/notre-expertise.php', false, false ) ); ?></div>
