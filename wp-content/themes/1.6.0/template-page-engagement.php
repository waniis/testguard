...
<?php /*
        ...
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6050eb9828d63311c8c26381" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Engagement" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="engagement">
  ...
  <div class="header-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
    <div class="header-inside">
      ...
      <div class="marque-btn-container">
        <a href="<?php echo home_url().'/notre-expertise/' ?>" class="btn-arrow-white w-inline-block">
          ...
          <div class="btn-text"><?php _e('Notre expertise', 'guard-industrie') ?></div>
        </a>
      </div>
    </div>
  </div>
  <div class="marque-block"><?php include( locate_template( 'template-parts/marque/nos-engagements.php', false, false ) ); ?></div>
