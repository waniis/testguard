<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="608a7edf2fa9b96db54db376" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Témoignages" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="temoignages">
  ...
  <div class="testimony-section"><?php include( locate_template( 'template-parts/single-testimony.php', false, false ) ); ?></div>
