...
if(document.querySelector('.section-landing-video')){
...
function scratchImage() {
    ...
    if (isDesktop()) {
        ...
        setTimeout(function() {
            ...
            img.src = canvas.getAttribute('data-before-url-mobile');
            setTimeout(function() {
                canvas.style.backgroundImage = "url(" + canvas.getAttribute('data-after-url-mobile') + ")";
            }, 1500);
    }
