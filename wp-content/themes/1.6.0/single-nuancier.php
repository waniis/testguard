<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="60a5221f634e1b2b766580b7" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="single-nuancier">
    ...
    <div class="main-wrapper">
      <div class="nuancier-single-title-container">
        <div class="nuancier-title">
          <a href="<?php echo home_url().'/le-nuancier/' ?>" class="back-to-list w-inline-block">
          ...
          <h1 class="main-title-black"><?php the_title(); ?></h1>
        </div>
      </div>
      <div class="nuancier-container">
        <div class="nuancier active">
          <!--<h3 class="heading-22">-->
          <!--  <?php the_field('nuancier_color'); ?>-->
          <!--</h3>-->
          <div class="nuancier-list">
            <?php if( have_rows('nuancier_block_10') ): ?>
              <?php while( have_rows('nuancier_block_10') ): the_row(); ?>
                  <?php if( get_sub_field('nuancier_10_img') ): ?>
                    <div style="background-image: url(<?php the_sub_field('nuancier_10_img'); ?>); background-size:cover;" class="nuancier-item w-inline-block">
                      <div class="nuancier-effect">
                        <?php the_sub_field('nuancier_10_title'); ?>
                      </div>
                    </div>
                  <?php endif; ?>
              <?php endwhile; ?>
            <?php endif; ?>
             ...
             <?php if( have_rows('nuancier_block_50') ): ?>
              <?php while( have_rows('nuancier_block_50') ): the_row(); ?>
                 <?php if( get_sub_field('nuancier_50_img') ): ?>
                  <div style="background-image: url(<?php the_sub_field('nuancier_50_img'); ?>); background-size:cover;" class="nuancier-item w-inline-block">
                    <div class="nuancier-effect">
                      <?php the_sub_field('nuancier_50_title'); ?>
                    </div>
                  </div>
                 <?php endif; ?>
              <?php endwhile; ?>
            ...
            <div style="background-image: url(<?php the_post_thumbnail_url('full') ?>); background-size:cover;" class="nuancier-item w-inline-block">
              <div class="nuancier-effect">
                <?php the_field('title_100'); ?>
              </div>
            </div>
      ...
      <div class="nuancier-single-btn-container">
        <a href="<?php echo the_field('nuancier_file','options') ?>" download class="btn-arrow-border-blue first w-inline-block" data-trk-telechargement-nuanciers="Nuancier - <?php the_title(); ?>">
          ...
          <div class="btn-text"><?php _e('Telecharger le nuancier', 'guard-industrie') ?></div>
        </a>
        <a href="<?php echo home_url().'/contactez-nous/'?>" class="btn-arrow-border-blue w-inline-block">
          <div class="btn-arrow-picto w-embed">
            <!--?xml version="1.0" encoding="UTF-8"?-->
            <svg viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
          ...
          <div class="btn-text"><?php _e('Nous Contacter', 'guard-industrie') ?></div>
        </a>
      </div>
    </div>
  </div>
