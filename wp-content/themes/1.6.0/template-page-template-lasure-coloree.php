<!DOCTYPE html>
<?php /*
        Template Name: template-lasure-coloree
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6086e8738911352560b443d9" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Template lasure coloree" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body-navless'; ?>" udesly-page="template-lasure-coloree">
  ...
  <div class="expertise-content"><?php include( locate_template( 'template-parts/lasure-coloree.php', false, false ) ); ?></div>
