<!DOCTYPE html>
<?php /*
        Template Name: template-coming-soon-blue
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="606483bc7ab6ea5bdaed75cf" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body-navless'; ?>" udesly-page="template-coming-soon-blue">
  ...
  <div class="content-section coming-soon blue">
