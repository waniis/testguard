<!DOCTYPE html>
<?php /*
        Template Name: template-home-prescripteurs
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="606482478aec066e31647c30" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Template Coming-soon" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="template-home-prescripteurs">
  
  <?php wp_body_open(); ?>
  
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  <nav class="nav"><?php include( locate_template( 'template-parts/nav.php', false, false ) ); ?></nav>
  <div class="header-coming-soon"><?php include( locate_template( 'template-parts/components/header-coming-soon.php', false, false ) ); ?></div>
  <div class="home-prescripteur"><?php include( locate_template( 'template-parts/home-prescripteurs.php', false, false ) ); ?></div>
