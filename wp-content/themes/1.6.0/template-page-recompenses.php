<!DOCTYPE html>
<?php /*
        Template Name: recompenses
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6050e32c48de15442d1f2d77" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Engagements" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="recompenses">
  ...
  <div class="header-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
    <div class="header-inside">
      ...
      <div class="marque-btn-container">
        <a href="<?php echo home_url().'/nos-engagement/' ?>" class="btn-arrow-white w-inline-block">
          ...
          <div class="btn-text"><?php _e('Nos engagements', 'guard-industrie') ?></div>
        </a>
      </div>
    </div>
  </div>
  <div class="marque-block"><?php include( locate_template( 'template-parts/marque/nos-recompenses.php', false, false ) ); ?></div>
