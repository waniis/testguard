...
<?php /*
        ...
        */ ?> 
  <html <?php language_attributes(); ?> data-wf-page="6050e3a598ab8010596ff7ab" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Histoire" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="histoire">
  ...
  <div class="marque-block"><?php include( locate_template( 'template-parts/marque/histoire.php', false, false ) ); ?></div>
