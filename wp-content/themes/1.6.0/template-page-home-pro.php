...
<?php /*
        ...
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="60548c832906a8751acb4cdc" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Home Pro" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="home-pro">
        ...
        <div class="swiper-slide header-slide">
          <div class="slide-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
            <div class="slide-inside">
              ...
              <h3 class="slide-subtitle"><?php the_content(); ?></h3>
              <a href="<?php the_field('catalogue_pro', 'option'); ?>" class="btn-arrow-white w-inline-block">
                ...
                <div class="btn-text"><?php _e('Voir nos produits', 'guard-industrie') ?></div>
              </a>
            </div>
          </div>
        </div>
  ...
  <div class="home-pro-content"><?php include( locate_template( 'template-parts/home-pro.php', false, false ) ); ?></div>
