<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="6051ca1a7d76f52ee212b856" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Template default" property="twitter:title">
...
<body class="body <?php echo join(' ', get_body_class() ) . ' body-navless'; ?>" udesly-page="template-default">
  ...
  <script type="text/javascript">
    ...
    let contactFormSuccessObject = window.dataLayer.filter(obj => {
      return obj.event === "contact-form-success";
    })
  
    const selectSubject = document.getElementById('input_1_6');
    selectSubject.addEventListener('change', (e) => {
      contactFormSuccessObject[0].formSubject = e.target.value;
    })
    
    const selectGamme = document.getElementById('input_1_7'); 
     selectGamme.addEventListener('change', (e) => {
      contactFormSuccessObject[0].gamme_produit = e.target.value;
    })
  </script>
