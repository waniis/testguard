<!DOCTYPE html>
<html <?php language_attributes(); ?> data-wf-page="6038c7ab31e181f99b853970" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="detail_product">
  
  <?php wp_body_open(); ?>
  
  <?php if (have_posts()) : while (have_posts()) : the_post(); $udesly_upsells = udesly_wc_get_upsells(); $udesly_related = udesly_wc_get_related(); ?>
  <nav class="nav"><?php include( locate_template( 'template-parts/nav.php', false, false ) ); ?></nav>
  
  
  <div class="product-section"><?php include( locate_template( 'template-parts/single-product.php', false, false ) ); ?></div>
...
<?php wp_footer(); ?><?php endwhile; endif; ?><script id="udy-wc-product-images"><?php echo udesly_wc_single_product_images_script(); ?></script></body></html>