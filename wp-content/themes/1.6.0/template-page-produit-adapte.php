<!DOCTYPE html>
<?php /*
        Template Name: produit-adapte
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="6098ef6666be8b71b9b46b90" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Produit adapté" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="produit-adapte">
  ...
  <div class="header-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
    <div class="header-inside">
      ...
      <div class="projet-btn-container">
        <a href="<?php the_field('reference_link', 'options') ?>" class="btn-arrow-white w-inline-block">
          ...
          <div class="btn-text"><?php _e('Nos références', 'guard-industrie') ?></div>
        </a>
      </div>
    </div>
  </div>
  <div class="project-section"><?php include( locate_template( 'template-parts/produit-adapte.php', false, false ) ); ?></div>
