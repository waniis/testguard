<!DOCTYPE html>
<?php /*
        Template Name: home-particuliers
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="60548be0563e1190a43a0ec6" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Home Particuliers" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="home-particuliers">
  
  <?php wp_body_open(); ?>
  
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  <nav class="nav"><?php include( locate_template( 'template-parts/nav.php', false, false ) ); ?></nav>
  <div class="home-particuliers-content"><?php include( locate_template( 'template-parts/home-particuliers.php', false, false ) ); ?></div>
