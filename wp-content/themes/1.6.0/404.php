<html>
    <head>
      ...
      <link href="<?php echo get_stylesheet_directory_uri(); ?>/images/favicon.png?v=1617264019169" rel="shortcut icon" type="image/x-icon">
      <link href="<?php echo get_stylesheet_directory_uri(); ?>/images/webclip.png?v=1617264019169" rel="apple-touch-icon">
        
      <link rel="stylesheet" href="https://guard-industrie.disko.love/wp-content/assets/quickfix/style.css">
      <?php wp_enqueue_script("jquery"); wp_head(); ?>
</head>
    </head>
<body class="body body-navless page404">
  ...
  <div class="header">
    <div class="header-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
      <div class="header-inside" style="text-align: center;">
          <div class="inside-404" style="position:relative; z-index:1;">
            <h2 class="main-title-white">
                Erreur 404
            </h2>
            <div class="paragraph-white">
             <?php echo the_field('404_text','options') ?>
            </div>
            <div class="btn-404-container">
              <a href="<?php echo home_url(); ?>" class="btn-arrow-white w-inline-block">
                ...
                <div class="btn-text">page d'accueil</div>
                </a>
            </div>
          </div>
      </div>
  ...
  <script type="text/javascript">var $ = window.jQuery;</script><script src="<?php echo get_stylesheet_directory_uri(); ?>/js/webflow.js?v=1617264019169" type="text/javascript"></script>
  <!-- [if lte IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/placeholders/3.0.2/placeholders.min.js"></script><![endif] -->

  <script type="text/javascript">var $ = window.jQuery;</script><script src="<?php echo get_stylesheet_directory_uri() .'/assets/js/global.js'; ?>"></script>
