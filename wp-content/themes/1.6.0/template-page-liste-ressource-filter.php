<!DOCTYPE html>
<?php /*
        Template Name: liste-ressource-filter
        */ ?> 
        <html <?php language_attributes(); ?> data-wf-page="608a79c58e4654a3a362459a" data-wf-site="6033b6808f1a9c208c41042d"><head>
  <meta charset="utf-8">
  
  
  <meta content="Liste-video" property="twitter:title">
...
<body class="<?php echo join(' ', get_body_class() ) . ' body'; ?>" udesly-page="liste-ressource-filter">
  ...
  <div class="header">
    <div class="header-box" style="background-image: url(<?php the_post_thumbnail_url('full') ?>)">
      <div class="header-inside">
        ...
        <?php $search = get_field('has_searchbar'); if( $search ): ?>
  ...
  <div class="listing-container">
    <div class="listing-ressource-wrapper">
      <div class="listing-ressource">
        <div class="listing-filter-block">
          <div class="filter-heading"><?php _e('Filtrer par :', 'guard-industrie') ?></div>
          <div class="filter-wrapper"><?php filters_Products(get_field('product_list_grid_id')); ?></div>
        </div>
